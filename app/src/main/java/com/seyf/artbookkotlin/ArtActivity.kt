package com.seyf.artbookkotlin
...
import com.seyf.artbookkotlin.databinding.ActivityArtBinding
        ...
        activityResultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == RESULT_OK) {
                ...
                if (intentFromResult != null) {
                    val imageData = intentFromResult.data // binding.imageView.setImageURI(imageDate)
                    try {
